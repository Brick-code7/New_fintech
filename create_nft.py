...
mn = 'mosquito language globe ankle connect source gold denial sleep mimic vacant source flee find normal hand truly wife power bike lizard unaware open absent gas'
...
# example: ASSET_OPTIN
sp = algod_client.suggested_params()
receiver_address = "LV4E3NGZ5AJMPT3EUXHDAMSHXXE6EHJO47QINULA5ZAK6T3244O3AAUC7E"
# Create opt-in transaction
# asset transfer from me to me for asset id we want to opt-in to with amt==0
optin_txn = transaction.AssetOptInTxn(
    sender="LV4E3NGZ5AJMPT3EUXHDAMSHXXE6EHJO47QINULA5ZAK6T3244O3AAUC7E", sp=sp, index=created_asset
)
signed_optin_txn = optin_txn.sign(private_key="Snr9IVdQkM7Ofybke+Lz6GinFD1KKXS+nzpoD8W5eVddeE202egSx89kpc4wMke9yeIdLufghtFg7kCvT3rnHQ==")
